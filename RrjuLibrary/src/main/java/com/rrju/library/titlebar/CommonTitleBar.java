package com.rrju.library.titlebar;
...
import com.rrju.library.utils.ScreenUtils;
import com.rrju.library.utils.StatusBarUtils;
...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initGlobalViews(Context context) {
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, ScreenUtils.dip2px(context, 0.4f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, ScreenUtils.dip2px(context, 0.4f)));
            ...
            LayoutParams bottomShadowParams = new LayoutParams(MATCH_PARENT, ScreenUtils.dip2px(context, bottomShadowHeight));
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            // 设置跑马灯效果
            tvCenter.setMaxWidth((int) (ScreenUtils.getScreenWidth(context) * 3 / 5.0));
            ...
            int progressWidth = ScreenUtils.dip2px(context, 18);
            ...
            // 设置边距
            centerParams.topMargin = ScreenUtils.dip2px(context, 7);
            centerParams.bottomMargin = ScreenUtils.dip2px(context, 7);
            ...
            int searchIconWidth = ScreenUtils.dip2px(context, 15);
            ...
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX, ScreenUtils.dip2px(context, 14));
