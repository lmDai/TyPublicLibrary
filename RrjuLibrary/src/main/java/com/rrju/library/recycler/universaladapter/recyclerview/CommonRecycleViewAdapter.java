...
import com.rrju.library.recycler.bean.PageBean;
import com.rrju.library.recycler.universaladapter.DataIO;
    ...
    protected void setListener(final ViewGroup parent, final ViewHolderHelper viewHolder, int viewType) {
        ...
        viewHolder.getConvertView().setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (mOnItemClickListener != null) {
                    int position = getPosition(viewHolder);
                    return mOnItemClickListener.onItemLongClick(parent, v, mDatas.get(position - 2), position);
                }
                return false;
            }
        });
