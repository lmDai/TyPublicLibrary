...
public class RoundImageView extends ImageView {
    ...
    public static final int TYPE_DEFAYLE = -1;
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        type = a.getInt(R.styleable.RoundImageView_type, TYPE_DEFAYLE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getDrawable() == null || type == TYPE_DEFAYLE) {
            super.onDraw(canvas);
            return;
        }
