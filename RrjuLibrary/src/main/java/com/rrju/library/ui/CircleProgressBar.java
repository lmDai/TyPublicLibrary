...
public class CircleProgressBar extends View {
	static final ColorFilter PRORESS_BACKGROUP_FILTER = new LightingColorFilter(
	...
	private void init(Context context, AttributeSet attrs) {
		if (attrs != null) {
			...
			mProgressDrawable = ta
					.getDrawable(R.styleable.CircleProgressBar_progressDrawable);
			if (mProgressDrawable != null) {
				setProgressDrawable(mProgressDrawable);
			}

			mIndeterminateDrawable = ta
					.getDrawable(R.styleable.CircleProgressBar_indetermiateDrawable);
			...
			setIndeterminate(ta.getBoolean(
					R.styleable.CircleProgressBar_indetermiate, false));
			mNoInvalidate = false;
			ta.recycle();
		}
	}
...
class AnimatedRotateDrawable extends Drawable implements Drawable.Callback,
	...
	// R.styleable.AnimatedRotateDrawable_visible);
	//
	...
	// final float pivotX = pivotXRel ? tv.getFraction(1.0f, 1.0f) : tv
	// .getFloat();
	//
	// tv = a.peekValue(R.styleable.AnimatedRotateDrawable_pivotY);
	// final boolean pivotYRel = tv.type == TypedValue.TYPE_FRACTION;
	// final float pivotY = pivotYRel ? tv.getFraction(1.0f, 1.0f) : tv
	// .getFloat();
	//
	// final int framesCount = a.getInt(
	// R.styleable.AnimatedRotateDrawable_framesCount, 12);
	// final int frameDuration = a.getInt(
	// R.styleable.AnimatedRotateDrawable_frameDuration, 150);
	//
	// final int res = a.getResourceId(
	// R.styleable.AnimatedRotateDrawable_drawable, 0);
