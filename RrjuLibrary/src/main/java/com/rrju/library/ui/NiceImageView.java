...
public class NiceImageView extends AppCompatImageView {
    ...
    public NiceImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            } else if (attr == R.styleable.NiceImageView_border_widths) {
                borderWidth = ta.getDimensionPixelSize(attr, borderWidth);
            } else if (attr == R.styleable.NiceImageView_border_colors) {
            ...
            } else if (attr == R.styleable.NiceImageView_corner_radius_all) {
