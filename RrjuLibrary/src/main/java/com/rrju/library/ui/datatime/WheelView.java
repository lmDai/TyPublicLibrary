...
public class WheelView extends View {
     ...
     */
    public int ADDITIONAL_ITEM_HEIGHT = 15;

    /**
     * Additional width for items layout
     */
    public int ADDITIONAL_ITEMS_SPACE = 15;
    ...
    private void initResourcesIfNecessary() {
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setShadowLayer(0, 0.1f, 0.1f, 0xFFC0C0C0);
        }
    ...
    private String getTextItem(int index) {
        ...
        // 根据长度截取出剪裁后的文字
        String ellipsizeStr = (String) TextUtils.ellipsize(name, itemsPaint,
                itemsWidth, TextUtils.TruncateAt.MIDDLE);
        return ellipsizeStr;
    }
    ...
    private void createLayouts(int widthItems, int widthLabel) {
        ...
        if (!isScrollingPerformed
            ...
            if (!TextUtils.isEmpty(text)) {
                // 根据长度截取出剪裁后的文字
                text = (String) TextUtils.ellipsize(text, valuePaint,
                        widthItems, TextUtils.TruncateAt.MIDDLE);
            }
    ...
    private void drawValue(Canvas canvas) {
        valuePaint.setColor(getResources().getColor(R.color.wheel_view_text_selcted));
    ...
    private void drawItems(Canvas canvas) {
        ...
        itemsPaint.setColor(getContext().getResources().getColor(
                R.color.wheel_view_text_unselcted));
