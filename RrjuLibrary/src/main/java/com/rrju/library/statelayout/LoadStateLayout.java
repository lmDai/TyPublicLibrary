...
import com.rrju.library.ui.CircleProgressBar;
...
public class LoadStateLayout extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        if (progressViewId != -1) {
            ...
            progressBar = (CircleProgressBar) progressView.findViewById(R.id.progress_wheel);
        ...
        if (errorDrawable != null) {
            ...
            errorImageView.setImageResource(R.drawable.load_faile);
        }
        addView(errorView);
        /******************************************************************************************/
        ...
        if (emptyDrawable != null) {
            ...
            emptyImageView.setImageResource(R.drawable.load_empty);
        }
        addView(emptyView);
        /******************************************************************************************/
