...
/**
 * Created by tanyan on 2018-08-07.
 */

public class RichTextStringUtils {
    private RichTextStringUtils() {
     ...
     * @return {@link Builder}
     */
    public static Builder getBuilder(@NonNull CharSequence text, Context mContext) {
        return new Builder(text,mContext);
    }
    ...
    public static class Builder {
       ...
       // @ColorInt
        ...
        private Builder(@NonNull CharSequence text, Context activity) {
            this.text = text;
        ...
        public Builder setTextColor(int color) {
            this.foregroundColor = mActivity.getResources().getColor(color);
            return this;
        }
        ...
        public Builder setBackgroundColor(int color) {
            this.backgroundColor = mActivity.getResources().getColor(color);
            return this;
        }
         ...
         * @return {@link Builder}
         */
        public Builder setTextSize(int dip) {
            this.mTextSize = dip;
            return this;
        }
        /**
        ...
        private void setSpan() {
            ...
            if (mTextSize != 0) {
                AbsoluteSizeSpan absoluteSizeSpan = new AbsoluteSizeSpan(mTextSize,true);
                mBuilder.setSpan(absoluteSizeSpan, start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            if (xProportion != -1) {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(mActivity, bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(mActivity, uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(mActivity, resourceId), start, end, flag);
                    resourceId = 0;
