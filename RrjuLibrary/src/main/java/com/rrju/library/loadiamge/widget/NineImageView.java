...
public class NineImageView extends ViewGroup {
    ...
    private void init(Context context) {
        cellWidth = cellHeight = DisplayUtil.dip2px(context, 60);
        setMargin(3);
        setRoundCornerRadius(5);
        textColor = R.color.nine_image_text_color;
        textSize = 20;
        placeholderResId = R.drawable.default_load_image;
        errorResId = R.drawable.default_load_image;
    }
    ...
    public void setData(List<ImageData> data, LayoutHelper layoutHelper) {
        ...
        size = DisplayUtil.getSize(data);
        if (size > MAX_IMAGE_SIZE) {
            size = MAX_IMAGE_SIZE;
            data.get(MAX_IMAGE_SIZE - 1).text = "+" + String.valueOf(DisplayUtil.getSize(data) - MAX_IMAGE_SIZE);
        }
    ...
    public NineImageView setMargin(int margin) {
        this.margin = DisplayUtil.dip2px(getContext(), margin);
        return this;
    }
    ...
    public NineImageView setRoundCornerRadius(int roundCornerRadius) {
        this.roundCornerRadius = DisplayUtil.dip2px(getContext(), roundCornerRadius);
        return this;
    }
