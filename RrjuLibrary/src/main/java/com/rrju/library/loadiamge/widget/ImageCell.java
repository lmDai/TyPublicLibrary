package com.rrju.library.loadiamge.widget;
...
public class ImageCell extends AppCompatImageView {
    ...
    private void init() {
        ...
        cornerIconMargin = DisplayUtil.dip2px(getContext(), 3);
    ...
    private void initCornerIcon() {
        ...
        if (cornerIconDrawable != null) {
            cornerIconWidth = DisplayUtil.dip2px(getContext(), cornerIconDrawable.getIntrinsicWidth());
            cornerIconHeight = DisplayUtil.dip2px(getContext(), cornerIconDrawable.getIntrinsicHeight());
    ...
    public Drawable getGifDrawable() {
        if (gifDrawable == null) {
            gifDrawable = DisplayUtil.getTextDrawable(getContext().getApplicationContext(), 24, 14, 2, "GIF", 11, R.color.nine_image_text_background_color);
        }
        return gifDrawable;
    }
    ...
    public Drawable getLongDrawable() {
        if (longDrawable == null) {
            longDrawable = DisplayUtil.getTextDrawable(getContext().getApplicationContext(), 25, 14, 2, "长图", 10, R.color.nine_image_text_background_color);
        }
        return longDrawable;
    }
    ...
    public ImageCell setTextSize(int size) {
        textPaint.setTextSize(DisplayUtil.dip2px(getContext(), size));
