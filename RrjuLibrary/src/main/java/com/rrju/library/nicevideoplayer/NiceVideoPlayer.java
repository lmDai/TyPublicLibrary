...
public class NiceVideoPlayer extends FrameLayout
     ...
     * at com.xiao.nicevideoplayer.NiceUtil.hideActionBar(NiceUtil.java:67)
     * at com.xiao.nicevideoplayer.NiceVideoPlayer.enterFullScreen(NiceVideoPlayer.java:561)
     * at com.xiao.nicevideoplayer.TxVideoPlayerController.onClick(TxVideoPlayerController.java:380)
...
//                    ((IjkMediaPlayer)mMediaPlayer).setOption(4, "framedrop", 1L);
    ...
    @Override
    public void clickSharVideo() {
        clickListening.click();
    }

    private ShareClickListening clickListening;

    public void setOnShareClickListener(ShareClickListening listener) {
        this.clickListening = listener;
    }

    public interface ShareClickListening {
        void click();
    }
}
