package com.rrju.library.nicevideoplayer;
...
public class TxVideoPlayerController
    ...
    private FinshVideoDetailsListening finshListening;
    ...
    public void isHideSharButton(boolean isShow) {
        mShare.setVisibility(isShow ? INVISIBLE : VISIBLE);
...
//        mBack.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            ...
            mNiceVideoPlayer.clickSharVideo();
        } else if (v == this) {
    ...
    protected void updateProgress() {
        ...
        Log.e("showChangePosition", progress + "___" + NiceUtil.formatTime(position));
    }
    ...
    protected void showChangePosition(long duration, int newPositionProgress) {
        ...
        Log.e("showChangePosition", newPositionProgress + "___" + NiceUtil.formatTime(newPosition));
    ...
    public void setOnFinshVideoDetailsClickListener(FinshVideoDetailsListening listener) {
        this.finshListening = listener;
    }

    public interface FinshVideoDetailsListening {
        void click();
    }
}
