...
public class GestureCover extends BaseCover implements OnTouchGestureListener {
    ...
    private LinearLayout mBrightnessBox;
    private ImageView mCoverPlayerGestureOperationBrightnessIcon;
    private TextView mBrightnessText;
    private LinearLayout mFastForwardBox;
    ...
    public void onReceiverBind() {
        ...
        mVolumeBox = (LinearLayout) findViewById(R.id.cover_player_gesture_operation_volume_box);
        mVolumeIcon = (ImageView) findViewById(R.id.cover_player_gesture_operation_volume_icon);
        mVolumeText = (TextView) findViewById(R.id.cover_player_gesture_operation_volume_text);
        mBrightnessBox = (LinearLayout) findViewById(R.id.cover_player_gesture_operation_brightness_box);
        mCoverPlayerGestureOperationBrightnessIcon = (ImageView) findViewById(R.id.cover_player_gesture_operation_brightness_icon);
        mBrightnessText = (TextView) findViewById(R.id.cover_player_gesture_operation_brightness_text);
        mFastForwardBox = (LinearLayout) findViewById(R.id.cover_player_gesture_operation_fast_forward_box);
        mFastForwardStepTime = (TextView) findViewById(R.id.cover_player_gesture_operation_fast_forward_text_view_step_time);
        mFastForwardProgressTime = (TextView) findViewById(R.id.cover_player_gesture_operation_fast_forward_text_view_progress_time);
