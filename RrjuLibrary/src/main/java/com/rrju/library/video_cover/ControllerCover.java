...
public class ControllerCover extends BaseCover implements OnTimerUpdateListener, OnTouchGestureListener {
    ...
    public void onReceiverBind() {
        ...
        mTopContainer = (LinearLayout) findViewById(R.id.cover_player_controller_top_container);
        mBottomContainer = (LinearLayout) findViewById(R.id.cover_player_controller_bottom_container);
        mBackIcon = (ImageView) findViewById(R.id.cover_player_controller_image_view_back_icon);
        mTopTitle = (TextView) findViewById(R.id.cover_player_controller_text_view_video_title);
        mStateIcon = (ImageView) findViewById(R.id.cover_player_controller_image_view_play_state);
        mCurrTime = (TextView) findViewById(R.id.cover_player_controller_text_view_curr_time);
        mSeekBar = (SeekBar) findViewById(R.id.cover_player_controller_seek_bar);
        mTotalTime = (TextView) findViewById(R.id.cover_player_controller_text_view_total_time);
        mSwitchScreen = (ImageView) findViewById(R.id.cover_player_controller_image_view_switch_screen);
        mBottomSeekBar = (SeekBar) findViewById(R.id.cover_bottom_seek_bar);

        mSeekBar.setOnSeekBarChangeListener(onSeekBarChangeListener);
        mBackIcon.setOnClickListener(clickListener);
        mStateIcon.setOnClickListener(clickListener);
        mSwitchScreen.setOnClickListener(clickListener);
